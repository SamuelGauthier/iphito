...
const Eigen::MatrixXd C =
    (Eigen::MatrixXd(6, 6) << -6, 15, -10, 0, 0, 1, -3, 8, -6, 0, 1, 0, -0.5,
     1.5, -1.5, 0.5, 0, 0, 0.5, -1, 0.5, 0, 0, 0, -3, 7, -4, 0, 0, 0, 6, -15,
     10, 0, 0, 0)
        .finished();

TEST_CASE("control points, velocity and acceleration vectors of quintic"
          " Hermite curves can be accessed",
          "[Hermite5]") {
  ...
  Eigen::Matrix2Xd B =
      (Eigen::Matrix2Xd(2, 6) << p1, v1, a1, a2, v2, p2).finished() * C;
